                ...
                <ul class="navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="viewhouse.html" style="color:rgb(37, 36, 36);">Houses</a></li>
                            <li><a href="rating.php" style="color:rgb(37, 36, 36);">Rating</a></li>
                        </ul>
                    </li>
                    &nbsp; &nbsp;
                </ul>
...
{
 echo "<tr><td>".$result['id']."</td><td>".$result['t_id']."</td><td>".$result['rating']."</td></tr>";
}
echo "</table>";
?>
</div>
